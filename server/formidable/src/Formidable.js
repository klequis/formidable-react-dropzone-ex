...
class IncomingForm extends EventEmitter {
  constructor(options = {}) {
    ...
    // console.log('this.uploadDir', this.uploadDir);
    // console.log('this.uploaddir', this.uploaddir);
    // console.log('this.uploaddir', this._uploadPath());
  }
